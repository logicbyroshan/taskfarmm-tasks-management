...
TaskFarmm takes security seriously. We are committed to ensuring the safety of user data and maintaining a secure task orchestration platform.

---

## 🛡️ Supported Versions

We currently support the latest major release of TaskFarmm:
...
If you discover a security vulnerability within TaskFarmm, please **do not open a public GitHub issue**. Instead, follow responsible disclosure practices:
...
When running TaskFarmm in production environments:
